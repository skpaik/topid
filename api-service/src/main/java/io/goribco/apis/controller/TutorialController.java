...
import io.goribco.apis.repository.TutorialRepository;
...
@CrossOrigin(origins = AppConstants.crossOriginUrl)
@RestController
@RequestMapping("/api")
public class TutorialController {
    ...
    @GetMapping("/v0/tutorials/published")
